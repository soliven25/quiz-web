window.onload = function(){
    ...
    var questionArray =  ["default","노래를 들을 때 가사와 멜로디 중신경써서 듣는 것은?", /* 1 & 2 */
                         ...
                         "평소 감정을 조절하는게 어렵나요?", /* 7 */
                         "일상속에서의 휴식이란?", /* 8 */
                         "문제를 이해할 때 이론과 이미지 중 어떤 것이 도움이 되는가요?", /* 9 */
                         "집중력이 30분 이상 가지 않는다.", /* 10 */
                         "그림을 볼 때 세부 사항과 전체 그림 중 먼저 보는 것은?", /* 11 */
                         "종이접기 등 손으로 만들고 조립하는 놀이가 좋다.", /* 12 */
                         "감기에 자주 걸리는 편인가?", /* 13 */
                         "DIY나 제품을 조립할 때 설명서를 먼저 본다.", /* 14 */
                         "맞춤법을 잘 지키는 편이다.", /* 15 */
                         "주어진 일을 할 때 처리하는 스타일은?", /* 16 */
                         "나는 문제해결을 할 때 직관보다는 분석을 통해 해결한다.", /* 17 */
                         "주위 사람으로 부터 눈치 없다는 소리를 듣는다.", /* 18 */
                         "일을 할 때 하나가 끝나야 다음 과제로 넘어간다.", /* 19 */
                         "집안이 더럽다고 느끼면 수시로 정리를 한다.", /* 20 */
                         "끝"];
